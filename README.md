...
dependencies {
    implementation("dev.jonrapp:hyui:1.0")
}
```
...
HyUI provides a fluent API for binding events to UI elements with automatic cleanup.
...
- [GitHub Repository](https://github.com/jmrapp1/HyUI)
- [Issue Tracker](https://github.com/jmrapp1/HyUI/issues)
